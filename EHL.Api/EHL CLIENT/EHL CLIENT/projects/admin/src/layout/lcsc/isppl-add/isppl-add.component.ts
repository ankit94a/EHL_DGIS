...
@Component({
  selector: 'app-isppl-add',
  imports: [SharedLibraryModule],
  templateUrl: './isppl-add.component.html',
  styleUrl: './isppl-add.component.scss'
})
export class IspplAddComponent {
drone: FormGroup;
  ...
  wingId: number;
   wing: Wing[] = [];
  constructor(@Inject(MAT_DIALOG_DATA) data,private dialogRef: MatDialogRef<IspplAddComponent>,private authService: AuthService, private apiService: ApiService,private fb: FormBuilder,private toastr: ToastrService) {
    this.getWing()
